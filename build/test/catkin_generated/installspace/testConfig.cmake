...
if("FALSE" STREQUAL "TRUE")
  set(test_SOURCE_PREFIX /home/uvlab/swarms/catkin_ws/src/test)
  set(test_DEVEL_PREFIX /home/uvlab/swarms/catkin_ws/devel)
  set(test_INSTALL_PREFIX "")
  set(test_PREFIX ${test_DEVEL_PREFIX})
else()
  set(test_SOURCE_PREFIX "")
  set(test_DEVEL_PREFIX "")
  set(test_INSTALL_PREFIX /home/uvlab/swarms/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'test' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'uvlab <toremobjo@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'test' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/uvlab/swarms/catkin_ws/install/${idir}'.  Ask the maintainer 'uvlab <toremobjo@gmail.com>' to fix it.")
    endif()
